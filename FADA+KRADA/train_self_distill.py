...
from core.datasets import build_dataset_self_distill
...
def train(cfg, local_rank, distributed):
    ...
    src_train_data = build_dataset_self_distill(cfg, mode='train', is_source=True) 
...
def run_test(cfg, model, local_rank, distributed):
    ...
    test_data = build_dataset_self_distill(cfg, mode='test', is_source=False)
    if distributed:
