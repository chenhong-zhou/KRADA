        ...
        for fname in content:
            ...
            if self.split in  ["train", "test"]:
                label_dir = os.path.join(
                    self.data_root, "gtFine/%s/%s"
                                    % (self.split, name.split("_leftImg8bit")[0] + "_gtFine_label16IDs.png",))
                   
            else:
                label_dir = os.path.join(
                    self.data_root, "gtFine/val_unknown_3lei_0_12_unk_255/%s"
                                    % ( name.split("_leftImg8bit")[0] + "_gtFine_label16IDs.png",))
