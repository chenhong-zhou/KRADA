...
class WeightedBCEWithLogitsLoss(nn.Module):
    ...
    def weighted(self, input, target, weight_region):
    ...
    def forward(self, input, target, weight_region = None):
        if weight_region is not None:
            return self.weighted(input, target, weight_region)
        else:
            return self.weighted(input, target, None)
